    ...
    <News
      text={
        <>
          ...
          <p>
            マインクラフト関連の利用の際は<a className={style.link} href="https://www.minecraft.net/ja-jp/eula">マインクラフトエンドユーザーライセンス契約（EULA）</a>
          </p>
          <p>
          ...
          <p>作者：制作者</p>
          <p>ユーザー：制作されたものをダウンロードして利用する全てのプレイヤーのこと</p>
          ...
          <h3 className={style.marTop80}>○つまり普通のMITライセンスと何が違うのか</h3>
          <p>クレジット表記を再配布を伴う場合にのみ必須としている点と表記ルールの一部を緩和している点</p>
          <p>（その他は通常のMITライセンスと変わりません）</p>
        </>
      }
    />
  );
