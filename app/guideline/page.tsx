      ...
      <div className={style.main}>
        <div>
          <div>
            ...
            <p>
              二次配布：改造の有無に関わらず、作品のデータの全部または一部を特定多数以上に対して頒布することを指します。
              <br />
            ...
            <p className={style.marTop60}>
              初めに私の作品の配信を検討していただきありがとうございます！
            </p>
            <p>
              本ガイドラインは配信者さんへ制約を課すことを目的にしておらず、
              <br />
              「こんなこともやっていいよ♡」といった範囲を明確にすることで、
              <br />
              より安心して活動を行っていただけることを目指し、策定したものです。
            </p>
            <p>※特にお読みいただけなくても問題ないようには心掛けています。</p>
            <h3 className={style.marTop60}>用語</h3>
            ...
            <p className={style.marTop110}>
              何か不明点やその他ご感想などありましたらXのDMへお気軽にご連絡ください。
            </p>
            {/* ここからその他のガイドライン */}
            ...
            <p>
              作者は作品に関するあらゆる保証（バグ修正、質問対応も含む）を義務として負わず、
              <br />
            ...
            <p className={style.marTop110}>最終更新：2025/12/23</p>
          </div>
        </div>
      </div>
    </>
