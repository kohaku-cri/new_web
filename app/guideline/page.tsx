      ...
      <div className={style.main}>
        <div>
          <div>
            ...
            <p>
              二次配布：改造の有無に関わらず、作品のデータの全部または一部を特定多数、不特定者に対して頒布することを指します。
              <br />
            ...
            <p>
              本ガイドラインは配信者さんに追加制約を設けることを目的にしておらず、
              <br />
              「こんなこともやっていいよ♡」という範囲を明確にすることで、
              <br />
              より安心して配信活動を行っていただけることを目指して、策定したものです。
            </p>
            <h3 className={style.marTop60}>用語</h3>
            ...
            <p>
              作者の参加を望まない場合は、お手数ですが事前にご自身のアカウントから、私のXのDMへ下記の文をコピペしてお送りください。
            </p>
            <p>確認次第リアクションを付与します。</p>
            <p className={style.marTop20}>
              例文：
              <br />
              “私のアカウントで行うlive配信で作者の参加を望みません。”
            </p>
            ...
            <p>ご質問等に対しても通常と変わらないサポートをお約束します。</p>
            ...
            <p>
              作者は作品に関するあらゆる保証（例：バグ修正、質問対応など）を義務として負わず、
              <br />
              また作品に関して生じた事象について、いかなる責任も負うことはできません。
            </p>
            <p>ご了承ください。</p>
            <p>
            ...
            <p className={style.marTop110}>最終更新：2025/12/30</p>
          </div>
        </div>
      </div>
    </>
