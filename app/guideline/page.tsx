      ...
      <div className={style.main}>
        <div>
          <div>
            ...
            <h3 className={style.marTop60}>外部素材の使用</h3>
            <p>
              音楽やイラストなど作者が制作していない外部の素材を使用している場合があります。
            </p>
            <p>
