    ...
    <div className={style.main}>
      <div>
        <div>
          ...
          <p>また何か不明点やご感想などありましたらXのDMの方にお気軽にご連絡ください。</p>
          ...
          <h3 className={style.marTop60}>ロゴ及びサムネの使用</h3>
          <p>「そのまま」「ロゴ部分を切り抜いて」 などご自由にお使いください。</p>
          <p>※ただし外部素材を利用している可能性がある点に注意してください。</p>
          ...
          <p>ご了承ください。</p>
          <p>※保証については、限界に達しない限り対応するよう努力しています。</p>
